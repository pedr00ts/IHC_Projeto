...
import 'package:evaccine/completepageHumano.dart';
...
class PerfilJoaoPage extends StatelessWidget {
  final String email;
  final String name;
  ...
  const PerfilJoaoPage({super.key,
    required this.email,
    required this.name,
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => VaccinesCompletePage()),
              );
            },
            child: Text('Vacinas'),
          ),
